...
parser = argparse.ArgumentParser(description='IRN on ETT dataset')
...
# parser.add_argument('--use_multi_gpu', action='store_true', help='use multiple gpus', default=[0,1,2,3,4,5,6])
# parser.add_argument('--use_multi_gpu', action='store_true', help='use multiple gpus', default=[0,1])
# parser.add_argument('--use_multi_gpu', action='store_true', help='use multiple gpus', default=[0,1,2,3])
# parser.add_argument('--use_multi_gpu', action='store_true', help='use multiple gpus', default=True)
parser.add_argument('--devices', type=str, default='0,1,2,3,4,5,6,7',help='device ids of multile gpus')
                                                                                  
### -------  input/output length settings --------------                                                                            
parser.add_argument('--seq_len', type=int, default=96, help='input sequence length of IRN encoder, look back window')
...
parser.add_argument('--lr', type=float, default=0.009, help='optimizer learning rate')
