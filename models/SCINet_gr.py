...
class SCINet(nn.Module):
    ...
    def forward(self, x):
        ...
        # x=(x_ori*self.sig(x_heat)+x_ori+x_ori)/3
...
class MMACNN0(nn.Module):
    def __init__(self):
        ...
        self.cnn01=nn.Conv2d(1,4,3,padding=2,dilation=2)
        self.bn01 =  nn.GroupNorm(1,4)
        self.relu01 = nn.ReLU()
        self.cnn02=nn.Conv2d(4,4,3,padding=2,dilation=2)
        self.bn02 =  nn.GroupNorm(1,4)
        self.relu02 = nn.ReLU()
        self.cnn03=nn.Conv2d(4,4,3,padding=2,dilation=2)
        self.bn03 =  nn.GroupNorm(1,4)
        self.relu03 = nn.ReLU()
...
class MMACNN(nn.Module):
    def __init__(self):
        ...
        self.cnn01=nn.Conv2d(4,4,3,padding=2,dilation=2)
        self.bn01 =  nn.GroupNorm(1,4)
        self.relu01 = nn.ReLU()
        self.cnn02=nn.Conv2d(4,4,3,padding=2,dilation=2)
        self.bn02 =  nn.GroupNorm(1,4)
...
class MMA(nn.Module):
    def __init__(self):
        ...
        self.cnn0=MMACNN0()
        self.cnn1=nn.Conv2d(4,4,3,padding=2,dilation=2)
        self.cnn2=MMACNN()
        self.cnn3=MMACNN()
        self.cnn4=MMACNN()
        self.cnn5=MMACNN()
        ...
        self.tanh=nn.Tanh()
        self.channelcnn = cnn1x1(4, 1, bias=False)
    ...
    def forward(self, x):
        ...
        # print(x0.shape)
        xout=self.channelcnn(self.cnn6(xs+xir+x0+x))
        # print(xout.shape)
        return xout
